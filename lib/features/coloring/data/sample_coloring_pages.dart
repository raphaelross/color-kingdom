...
import 'cheerful_baby_panda_raster_regions.dart';
...
const ColoringPage sampleCuteElephantPage = ColoringPage(
  ...
  regions: [
    ...
    ColoringRegion(
      id: 'elephant-ear-left',
      name: 'Left Ear',
      defaultColor: _defaultTransparent,
    ),
    ColoringRegion(
      id: 'elephant-ear-right',
      name: 'Right Ear',
      defaultColor: _defaultTransparent,
    ),
    ColoringRegion(
    ...
    ColoringRegion(
      id: 'elephant-eye-left',
      name: 'Left Eye',
      defaultColor: _defaultTransparent,
    ),
    ColoringRegion(
      id: 'elephant-eye-right',
      name: 'Right Eye',
      defaultColor: _defaultTransparent,
    ),
    ColoringRegion(
    ...
    ColoringRegion(
      id: 'elephant-leg-front',
      name: 'Front Leg',
      defaultColor: _defaultTransparent,
    ),
    ColoringRegion(
      id: 'elephant-leg-back',
      name: 'Back Leg',
      defaultColor: _defaultTransparent,
    ),
  ],
...
const ColoringPage sampleCheerfulBabyPandaPage = ColoringPage(
  ...
  rasterRegionMetadata: RasterRegionMetadata(
    ...
    contentVersion: 'phase2f-part2b-panda-v2',
    imageWidth: 1024,
    imageHeight: 1536,
    regionMapEntries: cheerfulBabyPandaRasterMapEntries,
  ),
